...
public class Transform3
{
    ...
    public Transform3(Matrix4x4 m, Matrix4x4 i)
    {
        M = new Matrix4x4(m);
        I = new Matrix4x4(i);
    }

    public Transform3 multiply(Transform3 t)
    {
        return new Transform3(M.multiply(t.M), t.I.multiply(I));
    }
    ...
    public static Transform3 createIdentity()
    {
    ...
    public static Transform3 createTranslator(float x, float y, float z)
    {
        Transform3 r = new Transform3();
    ...
    public static Transform3 createScaler(float x, float y, float z)
    {
        Transform3 r = new Transform3();
        r.setAsScaler(x, y, z);
        return r;
    ...
    public static Transform3 createRotator(float xy, float xz, float yz)
    {
        Transform3 r = new Transform3();
